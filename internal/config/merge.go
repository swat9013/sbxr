...
func Merge(defaultDecl, userDecl, repoDecl Declaration) (Config, error) {
	...
	cfg.GlobalEgress = additive(additive(nil, defaultDecl.Egress), userDecl.Egress)
	cfg.SandboxEgress = additive(nil, repoDecl.Egress)
